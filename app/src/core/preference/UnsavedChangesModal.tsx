...
export default function UnsavedChangesModal({
  ...
  return (
    <div className="modal-overlay" onClick={handleOverlayClick} role="presentation">
      <div className="modal unsaved-modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="unsaved-modal-title">
        <div className="unsaved-modal__header">
          ...
          <h3 id="unsaved-modal-title">{t('modal_title')}</h3>
        </div>
            ...
            {changes.map((change) => (
              <div key={change.key} className="unsaved-modal__change-item">
                ...
                <div className="unsaved-modal__change-values">
                  ...
                  <svg className="unsaved-modal__arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
